...
export default function ReportStack({navigation, route}: any) {
    ...
    return (
        ...
        >
            <Stack.Screen name='ChildrenList' component={ChildrenListReportScreen} />

            <Stack.Screen name='StartReport' component={StartReportScreen} />
            <Stack.Screen name="SubCategory" component={ReportSubCategoryScreen} />
            <Stack.Screen name="CompleteReport" component={CompleteReportScreen} />
        </Stack.Navigator>
    )
}
